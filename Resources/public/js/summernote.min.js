!function (a) {
    ...
    var c = {bMac: navigator.appVersion.indexOf("Mac") > -1, bMSIE: navigator.userAgent.indexOf("MSIE") > -1 || navigator.userAgent.indexOf("Trident") > -1, bFF: navigator.userAgent.indexOf("Firefox") > -1, jqueryVersion: parseFloat(a.fn.jquery), bCodeMirror: !!b}, d = function () {
    ...
    }(), g = {version: "0.5.2", options: {width: null, height: null, focus: !1, tabsize: 4, styleWithSpan: !0, disableLinkTarget: !1, disableDragAndDrop: !1, codemirror: {mode: "text/html", lineNumbers: !0}, lang: "en-US", direction: null, toolbar: [
        ["style", ["style"]],
        ...
        this.bindKeyMap = function (a, b) {
            ...
            this.bindKeyMap(a, b.keyMap[c.bMac ? "mac" : "pc"]), a.editable.on("mousedown", v), a.editable.on("keyup mouseup", w), a.editable.on("scroll", x), a.editable.on("paste", y), a.handle.on("mousedown", z), a.popover.on("click", D), a.popover.on("mousedown", A), b.airMode || (b.disableDragAndDrop || I(a), a.toolbar.on("click", D), a.toolbar.on("mousedown", A), a.statusbar.on("mousedown", F));
        ...
        this.createLayoutByAirMode = function (b, e) {
            ...
            d.width && e.width(d.width), d.height > 0 && a('<div class="note-statusbar">' + u() + "</div>").prependTo(e);
